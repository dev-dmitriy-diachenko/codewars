...
// Simple tests:
console.log(apple(99) === `It's hotter than the sun!!`);
console.log(apple(100) === `It's hotter than the sun!!`);
console.log(apple(25) === 'Help yourself to a honeycomb Yorkie for the glovebox.');
console.log(apple(13) === 'Help yourself to a honeycomb Yorkie for the glovebox.');